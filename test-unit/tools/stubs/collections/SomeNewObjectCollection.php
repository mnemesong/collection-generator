 ...
 *
 * Generated by: mnemesong\collection-generator v.0.3
 */
class SomeNewObjectCollection implements \Countable, \JsonSerializable
{
     ...
     */
    public function removeObject(SomeNewObject $object): self
    {
     ...
     * @throws \ErrorException
     */
    public function removeAll(SomeNewObject $object): self
    {
     ...
     * @return $this
     */
    public function replaceItemByIndex(int $index, SomeNewObject $newItem): self
    {
