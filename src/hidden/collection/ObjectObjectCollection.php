 ...
 */
class ObjectObjectCollection implements \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    public function getIterator(): \Iterator
    {
        ...
        {
            protected ObjectObjectCollection $collection;
            protected ?int $elementIndex;

            /**
             * @param ObjectObjectCollection $collection
             * @param int $firstElementIndex
             */
            public function __construct(ObjectObjectCollection &$collection, int $firstElementIndex)
            {
             ...
             * @return \Mnemesong\CollectionGenerator\hidden\ObjectObject|null
             */
            public function current(): ?ObjectObject
            {
     ...
     * @return $this
     */
    public function replaceItemByIndex(string $index, ObjectObject $newItem): self
    {
